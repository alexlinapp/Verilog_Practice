...
HD_PWD='C:/Users/NODDL/Verilog_Practice/eq2/eq2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eq2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eq2.tcl -notrace
