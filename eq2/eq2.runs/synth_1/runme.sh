...
HD_PWD='C:/Users/NODDL/Verilog_Practice/eq2/eq2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eq2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eq2.tcl
